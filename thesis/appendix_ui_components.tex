...
\begin{lstlisting}[language=Dart, caption={EditorialPlaceCard Build Method Excerpt}]
  @override
...
\begin{lstlisting}[language=Dart, caption={ActivityTimelineTile Layout Structure}]
...
\begin{lstlisting}[language=Dart, caption={GlassmorphismContainer BackdropFilter}]
Container(
  decoration: BoxDecoration(
